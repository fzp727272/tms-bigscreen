...
import {color1,color2,color3,borderColor,colorbackground} from '../../style/color';
  ...
  render() {
    ...
    return (
      <LeftPage >
        {/* 顶部图表 */}
        <LeftTopBox>
          <BorderBox12  color={[ colorbackground,color1,]}  className='left-top-borderBox12' >
        ...
        {/* 底部图表 */}
        <LeftBottomBox>
          <BorderBox12 color={[colorbackground,color1]}   className='left-bottom-borderBox13'>
