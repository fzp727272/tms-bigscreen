...
export const mapOptions = (params) => ({
  ...
  geo: {
    ...
    itemStyle: {
      normal: {
        borderColor: borderColor, //区域边框颜色
        areaColor:colorbackground, //区域颜色
